...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="truthkeep_dashboard_shell_") as tmp:
        db_path = str(Path(tmp) / "dashboard_shell.db")
    ...
    print("## TruthKeep Dashboard Shell")
    print()
    print(response["dashboard_text"])
    print()
    print("[JSON]")
