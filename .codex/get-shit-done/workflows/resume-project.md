...
<required_reading>
@/home/hali/.openclaw/extensions/memory-aegis-v7/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/hali/.openclaw/extensions/memory-aegis-v7/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)
