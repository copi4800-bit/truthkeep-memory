...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="truthkeep_command_center_") as tmp:
        db_path = str(Path(tmp) / "command_center.db")
        ...
        try:
            old_stored = app.put_memory(
                ...
                type="semantic",
                scope_type="agent",
                scope_id="command_center_demo",
                source_kind="manual",
                source_ref="demo://command-center-old",
            ...
            app.put_memory(
                ...
                scope_id="command_center_demo",
                source_kind="manual",
                source_ref="demo://command-center-new",
                subject="release.owner",
                confidence=1.0,
            ...
            response = app.command_center_shell(
                "release owner",
                scope_type="agent",
                scope_id="command_center_demo",
    ...
    print("## TruthKeep Command Center")
    print()
    print(response["command_center_text"])
    print()
    print("[JSON]")
