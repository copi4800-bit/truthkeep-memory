...
- **Global scope**: `/home/hali/.openclaw/extensions/memory-aegis-v10/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/hali/.openclaw/extensions/memory-aegis-v10/.codex/notes/`)
...
2. Glob `/home/hali/.openclaw/extensions/memory-aegis-v10/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/hali/.openclaw/extensions/memory-aegis-v10/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/hali/.openclaw/extensions/memory-aegis-v10/.codex/notes/` — works in any directory
