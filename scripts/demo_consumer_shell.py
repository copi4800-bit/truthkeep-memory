...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="truthkeep_consumer_shell_") as tmp:
        db_path = str(Path(tmp) / "consumer_shell.db")
    ...
    print("## TruthKeep Consumer Shell")
    print()
    print(response["shell_text"])
    print()
    print("[JSON]")
